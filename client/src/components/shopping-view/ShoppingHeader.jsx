...
{
  shoopingViewHeaderMenuItems.map((menuItem)=><Link className="text-sm font-medium"  key={menuItem.id} to={menuItem.path}>{menuItem.label}</Link>)
}
</nav>
}
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b bg-background ">
      ...
      <img src='/icon.svg' height={35} width={35}/>
        <span className="font-extrabold text-4xl bg-gradient-to-r from-gray-800 to-gray-500 text-transparent bg-clip-text  ">Emart</span>
      </Link>
