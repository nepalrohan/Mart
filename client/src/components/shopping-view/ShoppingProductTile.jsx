...
<h2 className='text-lg font-semibold text-primary mb-2 leading-tight'>{product?.title.slice(0, 40)+'...'}</h2>
<div className='flex justify-between items-center mb-2'>
    <span className='text-sm text-muted-foreground'>{product?.category[0].toUpperCase()+product?.category.slice(1)}</span>
    <span className='text-sm text-muted-foreground'>{product?.brand[0].toUpperCase()+product?.brand.slice(1)}</span>
