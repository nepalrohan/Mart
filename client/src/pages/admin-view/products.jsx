...
<div className='flex justify-end mb-5 w-full'>
  <Button onClick={()=>setOpenAddProduct(true)} className='cursor-pointer '>Add New Product</Button>
</div>
...
<SheetHeader>
  <SheetTitle className='font-bold text-center text-xl'>Add New Product</SheetTitle>
</SheetHeader>
